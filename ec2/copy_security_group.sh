...
SOURCE_SECURITY_GROUP_ID="${SOURCE_SECURITY_GROUP_ID:?Set SOURCE_SECURITY_GROUP_ID to a security group in SOURCE_REGION}"
TARGET_GROUP_NAME="${TARGET_GROUP_NAME:-smrol-ae}"
